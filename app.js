...
const UUID = process.env.UUID || '5796f623-752d-4f6a-bd9b-479908fe86ec';
...
const DOMAIN = process.env.DOMAIN || 'flare.aiusa.dpdns.org';  //项目域名或已反代的域名，不带前缀，建议填已反代的域名
const NAME = process.env.NAME || 'JP-webhostmost-meiguo';
